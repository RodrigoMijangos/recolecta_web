...
grep -q "timeout:" "$COMPOSE_FILE" || { echo "Error: Healthcheck timeout not found."; exit 1; }
grep -q "retries:" "$COMPOSE_FILE" || { echo "Error: Healthcheck retries not found."; exit 1; }
